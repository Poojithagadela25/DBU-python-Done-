...
Original file is located at
    https://colab.research.google.com/drive/1ZWzydmDeQ2QXKujubs5YeCkIOwDS3Qte
"""
...
os.chdir(os.path.dirname(os.path.abspath('/content/drive/MyDrive/Data/user_behavior_dataset.csv')))
